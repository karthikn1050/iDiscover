  ...
  return (
    <div className="" style={{width:"40%",marginLeft:"28%",marginTop:"11%",alignSelf:"center"}}>
      ...
      <div className="">
       ...
       <p>Don't have an Account!? <a href="" onClick={()=>setLogged(true)} style={{color:"blue"}}>SignUp</a></p>
        <div>
...
<div className=""> 
      ...
      <div className="">
       ...
       <p>Already have an Account!? <a href="" onClick={()=>setLogged(false)} style={{color:"blue"}}>Login</a></p>
        <div>
